/*
 * These classes are designed to create a wrapper
...
namespace WKLib.Helpers {
  ...
  public class BetterFolderBrowserDialog {
    ...
    public bool allow_multiselect; //public to prevent warning for this line (which was WRONG)
    ...
    public bool ShowDialog(IntPtr hWndOwner) {
      ...
      if (Environment.OSVersion.Version.Major >= 6) {
        ...
        uint num = 0;
        Type typeIFileDialog = r.GetTypeInstance("FileDialogNative.IFileDialog");
